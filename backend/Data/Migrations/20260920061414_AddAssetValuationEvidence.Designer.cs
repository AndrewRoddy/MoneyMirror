...
namespace MoneyMirror.backend.Data.Migrations
{
    ...
    [Migration("20260920061414_AddAssetValuationEvidence")]
    partial class AddAssetValuationEvidence
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MoneyMirror.Data.Entities.AssetValuationEvidenceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");

                    b.Property<Guid>("AssetValuationRecordId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("AssetValuationRecordId");

                    b.ToTable("AssetValuationEvidenceRecords");
                });
            ...
            modelBuilder.Entity("MoneyMirror.Data.Entities.AssetValuationEvidenceRecord", b =>
                {
                    b.HasOne("MoneyMirror.Data.Entities.AssetValuationRecord", "AssetValuationRecord")
                        .WithMany("Evidence")
                        .HasForeignKey("AssetValuationRecordId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AssetValuationRecord");
                });
